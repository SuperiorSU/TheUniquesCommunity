...
const Slick = () => {
  ...
  return (
    <div className='slider-container w-11/12 mx-auto gap-3'>
      <Slider {...settings}>
        {data.map((item) => (
          <div key={item.id} className='md:pr-3 py-2'>
            <div className='flex flex-col p-3 mx-auto sm:mx-0 md:mx-0 lg:mx-0 justify-around rounded-md shadow-md outline-2 h-[350px]'>
