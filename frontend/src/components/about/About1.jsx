          ...
          <div className="flex flex-wrap items-center justify-between -mx-4">
              ...
              <div className="flex items-center -mx-3 sm:-mx-4">
                ...
                <div className="w-full px-5">
                  <div className="relative z-10 my-4">
                    <img
                      src="https://media.licdn.com/dms/image/D5603AQGy5zkY1c0wXg/profile-displayphoto-shrink_800_800/0/1710042388840?e=1718236800&v=beta&t=MnKC8-mDowYb_XE-ypX1xcHGM5VMUs7Xh4w5wkkRDps"
                      alt=""
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="mt-10 lg:mt-0">
                ...
                <p className="mb-5 text-base text-body-color text-justify dark:text-dark-6">
                ...
                <p className="mb-8 text-base text-body-color text-justify dark:text-dark-6">
                ...
                <span className="flex items-center justify-center gap-x-6 lg:justify-end text-[#3F2455] block mb-4 text-base font-semibold text-primary">
                  CEO & Founder
                </span>
