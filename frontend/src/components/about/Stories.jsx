...
const Stories = () => {
  return (
    <div className="mt-10 mb-10 flex justify-center items-center">
      <div className="w-[80%]">
        <h1 className="text-3xl font-medium">Stories from the community</h1>
        <div className="flex justify-between flex-wrap mt-2 mb-3 items-center">
          ...
          <div className="flex flex-wrap my-4 md:my-0 gap-3 justify-center items-center">
            <div className="text-white py-1 px-2 rounded-sm font-semibold bg-[#ca0019] text-[12px] ">
              View more stories
            </div>
            <div className="text-[#ca0019] py-1 px-2 rounded-sm cursor-pointer font-semibold border hover:bg-[#d3979e48] text-[12px] ">
              Submit your story
            </div>
          </div>
        </div>
