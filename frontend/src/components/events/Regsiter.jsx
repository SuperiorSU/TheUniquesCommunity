...
const Regsiter = ({date,venue,formHandler}) => {
  ...
  return (
    <div className='w-10/12 mx-auto bg-white p-4 rounded-md shadow-md flex flex-wrap-reverse justify-between items-center'>
      ...
      <button onClick={formHandler} className='bg-red-800 text-white px-2 py-1 rounded-md mb-6 lg:mb-0 w-full lg:w-fit lg:h-auto'>Register</button>
    </div>
  )
}
